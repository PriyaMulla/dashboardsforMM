...
pixel_pattern_start = np.linspace(0, 256, num=n_pixel, endpoint=False, dtype=int) * (
    pixel_time * 1e12
)
...
flim = Flim(
    time_tag_virt,
    start_channel=delayed_sync,
    click_channel=photon_cfd,
...
plt.imshow(flim_mean, vmax=0.035)
plt.colorbar()
plt.figure()
# plot photons
